        ...
        if text=="":
            ...
            if boton["text"]=="Cerrar Sesión":
                if usernames.index(text)>=0:
                    ...
                    user_question=hoja[f'E{fila2}': f'E{fila2}']
