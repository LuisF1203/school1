"""Todas las librerias utilizadas"""
import pygame
import sys
import math
import time
...
pygame.font.init() #modulo de las fuentes
pygame.mixer.init() #reproductor de sonidos 
...
nombre_imagen_oculta = "recursos/oculta2.jpg"
...
"""
cuadros = [
    [Cuadro("recursos/A1.jpg"), Cuadro("recursos/A1.jpg"),
     Cuadro("recursos/A2.jpg"), Cuadro("recursos/A2.jpg")],
    [Cuadro("recursos/limiteA1.jpg"), Cuadro("recursos/limiteA1.jpg"),
     Cuadro("recursos/D2.jpg"), Cuadro("recursos/D2.jpg")],
    [Cuadro("recursos/i1.jpg"), Cuadro("recursos/i1.jpg"),
     Cuadro("recursos/G2.jpg"), Cuadro("recursos/G2.jpg")],
    [Cuadro("recursos/H1.jpg"), Cuadro("recursos/H1.jpg"),
     Cuadro("recursos/limiteB1.jpg"), Cuadro("recursos/limiteB1.jpg")],
]
...
# Los sonidos
"""sonido_fondo = pygame.mixer.Sound("recursos/fondo.wav")"""
sonido_clic = pygame.mixer.Sound("recursos/clic.mp3")
sonido_exito = pygame.mixer.Sound("recursos/ganador.mp3")
sonido_fracaso = pygame.mixer.Sound("recursos/equivocado.mp3")
sonido_voltear = pygame.mixer.Sound("recursos/voltear.mp3")
...
pygame.display.set_caption('VIDEOJUEGO A FIN DE ESTRATEGIA DE ENSEÑANZA PARA EL RAPIDO APRENDIZAJE DE CALCULO DIFERENCIAL en PYTHON')
...
while True:
    ...
    with open("puntuacion.txt") as archivo:
        for info in archivo:
            print(info)
            if int(info)>int(info):
                 with open("puntuacion.txt", "w") as f:
                    f.write(str(record))
